...
public class VerifyOTP extends AppCompatActivity {
    ...
    private void actionToolBar() {
        setSupportActionBar(tbOTP);
        getSupportActionBar().setTitle("Xác nhận mã OTP");
        getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        tbOTP.setNavigationIcon(R.drawable.arrow_back);
        tbOTP.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
