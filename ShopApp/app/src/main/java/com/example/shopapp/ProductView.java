...
public class ProductView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getProductToIdCate();
        // xử lý adapter
        rcyProductAdapter = new RcyProductAdapter(ProductView.this, R.layout.activity_rcy_product_items, list, new OnClickListener() {
            @Override
            public void onClickProductListener(int i, Product p) {
                Intent dataDetailProduct = new Intent(ProductView.this,DetailProduct.class);
                dataDetailProduct.putExtra("idProduct",p.getIdProduct());
                System.out.println(p.getIdProduct()+"");
                startActivity(dataDetailProduct);
            }
        });
        LinearLayoutManager layoutManager = new LinearLayoutManager(ProductView.this,LinearLayoutManager.VERTICAL,false);
...
//        list.add(new Product("Điện thoại Xiaomi Note 11 8GB RAM/128GB",9000000,"","Sản phẩm bán chạy nhất thị trường hiện tại"));
//        list.add(new Product("Điện thoại Xiaomi Note 11 8GB RAM/128GB",9000000,"","Sản phẩm bán chạy nhất thị trường hiện tại"));
//        list.add(new Product("Điện thoại Xiaomi Note 11 8GB RAM/128GB",9000000,"","Sản phẩm bán chạy nhất thị trường hiện tại"));
//        list.add(new Product("Điện thoại Xiaomi Note 11 8GB RAM/128GB",9000000,"","Sản phẩm bán chạy nhất thị trường hiện tại"));
//        list.add(new Product("Điện thoại Xiaomi Note 11 8GB RAM/128GB",9000000,R.drawable.smartphone,"Sản phẩm bán chạy nhất thị trường hiện tại"));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url_product, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ProductView.this,"Error"+error,Toast.LENGTH_SHORT).show();
                Log.d("Error",error+"");
            }
        }){
            @Nullable
...
//                Toast.makeText(ProductView.this, "Click vào giỏ hàng!", Toast.LENGTH_SHORT).show();
                Intent dataCart = new Intent(ProductView.this,CartCheckOut.class);
    ...
    private void actionToolBar() {
        ...
        tbBack.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent data = new Intent(ProductView.this,MainActivity.class);
                startActivity(data);
            }
        });
    }
